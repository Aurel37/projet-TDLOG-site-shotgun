...
--
-- Host: localhost:8889
-- Generation Time: Jan 13, 2020 at 03:31 PM
...
INSERT INTO `Cours` (`id`, `id_slot`, `id_langue`, `level`, `name`, `teacher`, `size`) VALUES
...
INSERT INTO `Sports` (`id`, `name`, `id_slot`) VALUES
(0, 'Tennis', 4),
(1, 'Basket', 1),
(2, 'Natation', 15),
(3, 'Danse', 1),
...
INSERT INTO `Students` (`id`, `name`, `first_name`, `sport`, `year`, `number_class`) VALUES

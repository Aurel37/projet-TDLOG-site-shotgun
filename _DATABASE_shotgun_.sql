...
INSERT INTO `Cours` (`id`, `id_slot`, `id_langue`, `level`, `title`, `teacher`, `size`) VALUES
...
INSERT INTO `Langue` (`id`, `title`) VALUES
(0, 'anglais'),
(1, 'espagnol'),
(2, 'allemand'),
(3, 'chinois'),
...
INSERT INTO `Slots` (`id`, `title`) VALUES
(0, 'Lundi- 11h30 / 13h00'),
(1, 'Lundi - 16h45 / 18h15'),
(2, 'Mardi - 12h30 / 14h00'),
(3, 'Mardi - 14h15 / 17h30'),
...
INSERT INTO `Sports` (`id`, `title`, `id_slot`) VALUES
(0, 'Tennis', 4),
(1, 'Basket', 1),
(2, 'Natation', 15),
(3, 'Danse', 1),
